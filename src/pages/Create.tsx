...
const Create = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!bucketExists) {
        toast.error("Post upload is not available. Please try again later.");
        setUploading(false);
        return;
      }
      ...
      if (uploadError) {
        ...
        toast.error(
          uploadError.message === "Bucket not found" 
            ? "Post upload service is unavailable. Please try again later."
            : uploadError.message || "Error uploading post"
        );
        setUploading(false);
        return;
      }
